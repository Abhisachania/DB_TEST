...
• This repository consists of files required to deploy a ___Web App(HTML,CSS,JAVASCIPT,BOOTSTRA,FLASK)___ created with ___on ___Microsoft___ Azure.# Diabetes_Predictor System
